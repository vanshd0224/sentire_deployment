...
export const ORGANIZATION_SCHEMA = {
  ...
  logo: {
    ...
    height: "512",
    caption:
      "SENTIRE By PC — Luxury Extrait de Parfum with Laser Bottle Engraving, Jaipur",
  },
  description:
    "Jaipur-based artisanal luxury fragrance house crafting 35%+ perfume oil extraits de parfum with bespoke laser photo & name flacon engraving.",
  foundingLocation: {
    "@type": "Place",
    address: {
      "@type": "PostalAddress",
...
export const JAIPUR_STORE_SCHEMA = {
  ...
  address: {
    "@type": "PostalAddress",
    streetAddress:
      "First Floor, 109-110, Beriwal Tower, Subhash Nagar Shopping Centre",
    addressLocality: "Jaipur",
    addressRegion: "Rajasthan",
    postalCode: "302016",
    addressCountry: "IN",
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            "High-precision laser etching of portraits, images, and custom line art directly onto luxury perfume glass flacons.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Personalized typography engraving of names, anniversary dates, and messages on perfume bottles.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Break-proof express fragrance delivery across Jaipur, Delhi NCR, Mumbai, Bangalore, and all Indian pincodes.",
        },
      },
    ],
  },
...
export function generateProductSchema(product: PerfumeProduct) {
    ...
    return {
      ...
      additionalProperty: [
        ...
        },
        {
          ...
          value:
            size === 50
              ? "Photo and Name Laser Bottle Engraving"
              : "Standard Luxury Flacon",
        },
        {
          "@type": "PropertyValue",
  ...
  return {
    ...
    description:
      product.fullDesc ||
      `${product.desc}. Formulated with rare 35%+ pure perfume oil concentration for eternal longevity and sillage. Includes complimentary precision laser bottle engraving.`,
    url: canonicalUrl,
    brand: {
      "@type": "Brand",
      name: "SENTIRE By PC",
  ...
  if (product) {
    ...
    graph.push(
      generateItemListSchema(
        "SENTIRE Extrait de Parfum Collection",
        ALL_PERFUMES,
      ),
    );
    ...
    graph.push(
      generateItemListSchema(
        "SENTIRE Best-Selling Extraits de Parfum",
        bestSellers.length ? bestSellers : ALL_PERFUMES.slice(0, 4),
      ),
    );
    ...
    const newArrivals = ALL_PERFUMES.filter(
      (p) => p.badge === "new" || p.badge === "exclusive",
    );
    graph.push(
      generateItemListSchema(
        "SENTIRE New Artisanal Perfume Arrivals",
        newArrivals.length ? newArrivals : ALL_PERFUMES.slice(0, 4),
      ),
    );
