...
export default function WatchAndBuy({
  ...
  return (
    <section className="w-full bg-[#f2f2f0] py-12 sm:py-16 overflow-hidden">
      ...
      {toastMsg && (
        <div
          className="on-dark fixed z-[99999999] left-1/2 -translate-x-1/2 rounded-full border border-[color:var(--accent)]/60 bg-[#161616] px-6 py-3 text-xs font-bold text-white shadow-2xl flex items-center gap-2 animate-fadeIn"
          style={{
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      className="on-dark relative overflow-hidden rounded-[4px] bg-black shadow-md border border-black/10 h-[270px] sm:h-[340px] group-hover:shadow-xl transition-all duration-300 cursor-pointer"
                      style={{ width: `${cardWidth}px` }}
                    >
                      {" "}
                    ...
                    <div className="mt-2.5 flex items-center justify-between gap-1 px-1">
                      ...
                      <div className="min-w-0 flex-1">
                        {" "}
                        <p className="truncate text-[11px] max-sm:text-[12px] sm:text-[12px] font-bold text-[#161616] uppercase tracking-wide">
                          {" "}
                          {reel.product}
                        </p>{" "}
                        <div className="mt-0.5 flex items-center gap-1.5 flex-wrap">
                          {" "}
                          <span className="text-[11px] max-sm:text-[12px] sm:text-[12px] font-extrabold text-[#161616]">
                            {reel.priceText}
                          </span>{" "}
                          <span className="text-[10px] max-sm:text-[12px] text-[#767676] line-through">
                            {reel.original}
                          </span>{" "}
                          <span className="text-[9px] max-sm:text-[12px] font-bold text-white bg-[#9e2a2b] px-1.5 py-0.5 rounded">
                            {" "}
                            {reel.badge}
                          </span>{" "}
                        </div>{" "}
      ...
      {shareModalReel && (
        ...
        >
          {" "}
          <div
            className="w-full max-w-md bg-[#f2f2f0] rounded-t-3xl sm:rounded-[4px] p-5 sm:p-6 shadow-2xl border border-[color:var(--accent)]/40 text-[#161616] relative animate-slideUp"
            onClick={(e) => e.stopPropagation()}
          >
            {" "}
            {/* Modal Header */}
            <div className="flex items-center justify-between pb-3 border-b border-black/10 mb-4">
              {" "}
              <h3 className="font-serif font-bold text-base sm:text-lg uppercase tracking-wide text-[#161616]">
                {" "}
                Share Fragrance
              </h3>{" "}
              <button
            ...
            {/* Product Preview Bar */}
            <div className="flex items-center gap-3 bg-white p-3 rounded-[4px] border border-black/10 mb-5 shadow-sm">
              {" "}
              <img
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] max-sm:text-[12px] text-black/60 truncate">
            ...
            <div className="grid grid-cols-4 gap-3 text-center mb-5">
              ...
              >
                {" "}
                <div className="h-12 w-12 rounded-[4px] bg-[#25D366] text-white flex items-center justify-center shadow-md group-hover:scale-105 transition-all">
                  {" "}
                ...
                <span className="text-[11px] max-sm:text-[12px] font-bold text-black/80">
                  WhatsApp
                </span>{" "}
              </a>{" "}
              {/* Instagram */}
              ...
              >
                {" "}
                <div className="h-12 w-12 rounded-[4px] bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white flex items-center justify-center shadow-md group-hover:scale-105 transition-all">
                  {" "}
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
                    {" "}
              ...
              >
                {" "}
                <div className="h-12 w-12 rounded-[4px] bg-[#1877F2] text-white flex items-center justify-center shadow-md group-hover:scale-105 transition-all">
                  {" "}
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
                    {" "}
              ...
              >
                {" "}
                <div className="on-dark h-12 w-12 rounded-[4px] bg-black text-white flex items-center justify-center shadow-md group-hover:scale-105 transition-all">
                  {" "}
            ...
            <div className="bg-white p-2 rounded-[4px] border border-black/15 flex items-center gap-2">
              {" "}
              <input
                type="text"
                readOnly
