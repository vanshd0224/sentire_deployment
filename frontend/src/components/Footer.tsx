...
function FacebookIcon() {
  return (
    ...
    >
      {" "}
      <path
        d="M15 8h-2a2 2 0 0 0-2 2v2H9v3h2v6h3v-6h2l1-3h-3v-1.5A.5.5 0 0 1 14.5 9H16z"
...
function MobileAccordionColumn({
  title,
  links,
  onNavigate,
}: {
            ...
            <li key={link}>
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  if (
                    link === "Product Personalisation" ||
                    link === "Personalised Perfumes"
                  ) {
                    ...
                    try {
                      window.history.pushState(
                        null,
                        "",
                        "/client-services#shipping-delivery",
                      );
                    } catch (err) {}
                    onNavigate?.("client-services");
                    setTimeout(() => {
