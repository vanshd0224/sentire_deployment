...
const PERFUMES: PerfumeOption[] = [
  {
    id: "purple-oud",
    name: "PURPLE OUD",
    sub: "Smoky Cambodian Oud & Saffron",
  ...
  },
  {
    id: "calantha",
    name: "CALANTHA",
    sub: "Blooming Jasmine, Sandalwood & Amber",
    image: "/assets/perfumes/calantha-50ml-3.png?v=3",
    price: 1085,
    notes: ["Jasmine Sambac", "Damask Rose", "Mysore Sandalwood"],
    tag: "Bestseller",
    category: "floral",
  },
  {
    id: "seductive",
    name: "SEDUCTIVE",
    sub: "Citric Limon & Velvet Amber",
    image: "/assets/perfumes/seductive-50ml-2.png?v=3",
    price: 1149,
    notes: ["Citric Limon", "French Lavender", "Velvet Amber"],
    tag: "Bestseller",
    category: "fresh",
  },
  {
    ...
    price: 1085,
    notes: ["Lavender", "Blonde Tobacco", "Sandalwood"],
    tag: "Bestseller",
    category: "floral",
  },
  {
    id: "0809",
    name: "0809",
    sub: "Sichuan Pepper & Warm Ambroxan",
    image: "/assets/perfumes/0809-50ml-1.png?v=10",
    price: 2889,
    notes: ["Sichuan Pepper", "French Lavender", "Ambroxan"],
    tag: "Prestige Icon",
    category: "oriental",
  },
  {
    id: "white-oud",
    name: "WHITE OUD",
    sub: "Essence of Oud & Pink Pepper",
    image: "/assets/perfumes/white-oud-50ml-1.png?v=2",
    price: 2889,
    notes: ["White Oud", "Star Jasmine", "Crystal Amber"],
    tag: "Rare Extrait",
    category: "woody",
  },
  {
    id: "herrlich",
    name: "HERRLICH",
    sub: "Fresh Fruits & Dark Chocolate",
    image: "/assets/perfumes/herrlich-50ml-3.png?v=3",
    price: 2196,
    notes: ["Peach & Bergamot", "Floral Bouquet", "Dark Chocolate"],
    tag: "New Arrival",
    category: "woody",
  },
  {
    id: "midnight",
    name: "MIDNIGHT",
    sub: "Blackcurrant & Vanilla Musk",
    image: "/assets/perfumes/midnight-50ml-1.png?v=2",
    price: 1949,
    notes: ["Blackcurrant", "Night Tuberose", "Vanilla Musk"],
    tag: "Night Edition",
    category: "woody",
  },
  {
    id: "mirai",
    name: "MIRAI",
    sub: "Vibrant Citrus & Patchouli",
    image: "/assets/perfumes/mirai-50ml-3.png?v=3",
    price: 1679,
    notes: ["Amalfi Lemon", "French Lavender", "Patchouli"],
    tag: "Bestseller",
    category: "fresh",
  },
  {
    id: "rich",
    name: "RICH",
    sub: "Opulent Bergamot & Spiced Rose",
    image: "/assets/perfumes/rich-50ml-1.png?v=2",
    price: 1593,
    notes: ["Cardamom", "Damask Rose", "Amber Resin"],
    tag: "Opulent Amber",
    category: "oriental",
  },
  {
    id: "personna",
    name: "PERSONNA",
    sub: "Mandarin & Spiced Rose Accord",
    image: "/assets/perfumes/personna-50ml-1.png?v=2",
    price: 1593,
    notes: ["Mandarin", "Black Pepper", "Rose Accord"],
    tag: "Artisanal",
    category: "oriental",
  },
];
...
export default function BundleBuilderModal({
  ...
  const discount = 250; // ₹250 bundle discount (3 bottles)
      ...
      >
        ...
        <div className="relative flex flex-col items-center justify-center overflow-hidden border-b border-[#a4492e]/30 px-6 py-7 text-center sm:py-9">
          ...
          <h2 className="font-display relative z-10 text-2xl uppercase tracking-widest text-white sm:text-4xl">
            BUILD YOUR <span className="text-[#a4492e] drop-shadow-[0_0_15px_rgba(164, 73, 46,0.5)]">3-BOTTLE BUNDLE</span>
          </h2>
          ...
          <div className="relative z-10 mt-4 flex flex-col items-center gap-3 w-full max-w-md">
            ...
            <div className="w-full space-y-1.5 px-4">
              <div className="flex items-center justify-between text-[11px] font-semibold text-cream/70">
                ...
                <span className="text-[#a4492e]">{filledCount} of 3 Slots Filled ({progressPercent}%)</span>
              </div>
                    ...
                    {item ? (
                      <div className="flex w-full flex-col items-center text-center space-y-1.5">
                        ...
                        <div>
                          ...
                          <p className="text-[9px] sm:text-[11px] text-[#a4492e] truncate max-w-[90px] sm:max-w-none">{item.sub}</p>
                        </div>
