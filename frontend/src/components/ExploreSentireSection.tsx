...
const exploreLinks = [
  {
    title: "All Perfumes",
    description:
      "Explore our complete 35%+ pure perfume oil extrait de parfum collection.",
    href: "/perfumes",
  ...
  },
  {
    title: "Best Sellers",
    description:
      "Discover the signatures our clients return to time and time again.",
    href: "/bestsellers",
  ...
  },
  {
    title: "New Arrivals",
    description:
      "Meet the latest high-concentration formulations and new creations.",
    href: "/new-arrivals",
  ...
  },
  {
    ...
    description:
      "Complimentary laser photo, name, and date bottle engraving on 50ml flacons.",
  ...
  },
  {
    ...
    description:
      "Curate your custom fragrance wardrobe with multi-bottle bundle savings.",
    href: "/byob",
    page: "byob" as const,
  ...
  },
  {
    ...
    description:
      "Follow your SENTIRE Jaipur maison shipment and live delivery status.",
    href: "/track-order",
...
export default function ExploreSentireSection({
  onNavigate,
}: ExploreSentireProps) {
  return (
    <section
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
          ...
          <p className="text-xs sm:text-sm text-ink/65 mt-2">
            {" "}
            Direct navigation across our artisanal fragrance collections,
            bespoke atelier services, and client concierge.
          </p>{" "}
        </div>{" "}
