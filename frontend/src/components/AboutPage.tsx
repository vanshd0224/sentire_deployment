  ...
  return (
    <div className="min-h-screen w-full bg-[#151412] text-[#f4f2ee] selection:bg-[#a4492e] selection:text-black font-sans relative overflow-x-hidden">
      ...
      <div className="sticky top-16 z-40 w-full border-b border-[#a4492e]/30 bg-black/90 backdrop-blur-2xl py-3 px-4 md:px-8 shadow-2xl transition-all">
        {/* Progress Bar Line */}
        <div className="absolute top-0 left-0 h-[2px] bg-gradient-to-r from-[#a4492e] via-[#d9a08a] to-[#a4492e] transition-all duration-300 shadow-[0_0_10px_#a4492e]" style={{ width: `${scrollProgress}%` }} />
      ...
      <section className="relative flex min-h-[90vh] w-full flex-col items-center justify-center overflow-hidden px-6 py-20 text-center lg:px-12">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#a4492e]/30 bg-[#a4492e]/10 px-4 py-1.5 text-[10px] font-extrabold uppercase tracking-[0.3em] text-[#d9a08a] shadow-[0_0_20px_rgba(164, 73, 46,0.2)]">
            <span className="h-1.5 w-1.5 rounded-full bg-[#d9a08a]" />
          ...
          <p className="max-w-2xl text-sm sm:text-base md:text-lg text-[#f4f2ee]/80 leading-relaxed font-light mb-10">
            Founded in Jaipur by entrepreneur Pranav Chaudhary, <strong className="text-white font-medium">SENTIRE By PC</strong> redefines niche perfumery. We synthesize French floral distillation with rare Indian Oud resins at an uncompromising <span className="text-[#d9a08a] font-semibold">35%+ Extrait de Parfum</span> concentration.
          </p>
      ...
      <section id="ch1" className="relative w-full border-t border-white/10 bg-[#080503] py-24 px-6 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-[#a4492e]">CHAPTER 01</span>
            <span className="h-[1px] w-12 bg-[#a4492e]/40" />
          </div>
          <h2 className="font-serif text-3xl sm:text-5xl font-bold text-white mb-6">
            Latin Genesis: What It Means to <span className="italic text-[#d9a08a]">Feel</span>
          </h2>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-6 text-[#f4f2ee]/80 text-sm sm:text-base leading-relaxed font-light">
              <p>
                The name <strong className="text-[#d9a08a] font-semibold">"SENTIRE"</strong> originates from the ancient Latin verb meaning <em>to feel, to perceive through senses, or to experience emotionally</em>. Scent is the only human sense directly wired into the brain’s limbic system—the seat of memory, passion, and instinct.
              </p>
              <p>
              ...
              <div className="p-6 rounded-2xl border border-[#a4492e]/30 bg-[radial-gradient(ellipse_at_top_left,rgba(164, 73, 46,0.12)_0%,transparent_70%)] backdrop-blur-xl">
                <div className="text-xs font-bold uppercase tracking-wider text-[#a4492e] mb-2">FOUNDER'S CORE CONVICTION</div>
      ...
      <section id="ch2" className="relative w-full border-t border-white/10 bg-[#151412] py-24 px-6 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-[#a4492e]">CHAPTER 02</span>
            <span className="h-[1px] w-12 bg-[#a4492e]/40" />
          </div>
          <h2 className="font-serif text-3xl sm:text-5xl font-bold text-white mb-6">
            Born in Jaipur, <span className="italic text-[#d9a08a]">December 2022</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5 rounded-3xl border border-[#a4492e]/40 bg-[linear-gradient(145deg,rgba(164, 73, 46,0.15)_0%,rgba(13,9,6,0.95)_100%)] p-8 backdrop-blur-2xl flex flex-col justify-between shadow-2xl relative overflow-hidden">
              ...
              <div>
                ...
                <p className="text-xs font-bold uppercase tracking-widest text-[#a4492e] mb-6">Creator &amp; Master Strategist ("PC")</p>
                ...
                <div className="flex rounded-xl bg-black/50 p-1 border border-white/10 mb-6">
                  <button
                    ...
                    className={`flex-1 rounded-lg py-1.5 text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
                      founderTab === "vision" ? "bg-[#a4492e] text-black shadow" : "text-white/60 hover:text-white"
                    }`}
                  >
                    The Origin
                  </button>
                  <button
                    ...
                    className={`flex-1 rounded-lg py-1.5 text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
                      founderTab === "craft" ? "bg-[#a4492e] text-black shadow" : "text-white/60 hover:text-white"
                    }`}
                  >
                    Engineering Mind
                  </button>
              ...
              <div className="border-t border-white/10 pt-4 flex items-center justify-between">
                ...
                <span className="text-xs font-bold text-[#d9a08a]">Jaipur, Rajasthan (302016)</span>
              </div>
            </div>
      ...
      <section id="ch3" className="relative w-full border-t border-white/10 bg-[#080503] py-24 px-6 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-[#a4492e]">CHAPTER 03</span>
            <span className="h-[1px] w-12 bg-[#a4492e]/40" />
          </div>
          <h2 className="font-serif text-3xl sm:text-5xl font-bold text-white mb-4">
            The Extrait Standard: <span className="italic text-[#d9a08a]">Interactive Ion Density Meter</span>
          </h2>
              ...
              <div className="lg:col-span-6 space-y-6">
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <label htmlFor="concentration-slider" className="text-xs font-bold uppercase tracking-widest text-[#a4492e]">
                      Fragrance Oil Concentration Tier
                    </label>
                    <span className="text-2xl font-bold font-serif text-[#d9a08a]">{concentration}%</span>
                  </div>
      ...
      <section id="ch4" className="relative w-full border-t border-white/10 bg-[#151412] py-24 px-6 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-[#a4492e]">CHAPTER 04</span>
            <span className="h-[1px] w-12 bg-[#a4492e]/40" />
          </div>
          <h2 className="font-serif text-3xl sm:text-5xl font-bold text-white mb-4">
            Interactive Olfactory <span className="italic text-[#d9a08a]">Alchemy Lab</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 rounded-3xl border border-[#a4492e]/40 bg-black/80 p-8 backdrop-blur-2xl shadow-2xl relative overflow-hidden">
                ...
                {[
                  ...
                  <div key={i}>
                    <div className="flex justify-between text-xs font-semibold text-white/80 mb-1">
                      <span>{bar.label}</span>
                      <span className="text-[#d9a08a] font-bold">{bar.val}%</span>
                    </div>
              ...
              <div className="rounded-xl border border-white/10 bg-white/5 p-4 flex items-center justify-between">
                ...
                <span className="text-xs font-bold text-[#d9a08a]">{selectedNote.tag}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="ch5" className="relative w-full border-t border-white/10 bg-[#080503] py-24 px-6 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-[#a4492e]">CHAPTER 05</span>
            <span className="h-[1px] w-12 bg-[#a4492e]/40" />
          </div>
          <h2 className="font-serif text-3xl sm:text-5xl font-bold text-white mb-6">
            Kannauj Craftsmanship: <span className="italic text-[#d9a08a]">The Deg &amp; Bhapka Legacy</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6 space-y-6 text-[#f4f2ee]/80 text-sm sm:text-base font-light leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                  <div className="text-2xl font-serif font-bold text-[#d9a08a]">400+ Years</div>
                  <div className="text-xs text-white/60 mt-1">Heritage Distillation Legacy</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                  <div className="text-2xl font-serif font-bold text-[#d9a08a]">Zero Harm</div>
            ...
            <div className="lg:col-span-6 rounded-3xl border border-[#a4492e]/30 bg-black/60 p-6 md:p-8 backdrop-blur-2xl">
              <div className="text-xs font-bold uppercase tracking-widest text-[#a4492e] mb-6">DISTILLATION WORKFLOW</div>
      ...
      <section id="ch6" className="relative w-full border-t border-white/10 bg-[#151412] py-24 px-6 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-xs font-bold uppercase tracking-[0.3em] text-[#a4492e]">CHAPTER 06</span>
            <span className="h-[1px] w-12 bg-[#a4492e]/40" />
          </div>
          <h2 className="font-serif text-3xl sm:text-5xl font-bold text-white mb-4">
            Tailored Luxury: <span className="italic text-[#d9a08a]">Bespoke Personalization</span>
          </h2>
          <p className="text-sm text-white/70 max-w-2xl font-light mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group rounded-3xl border border-[#a4492e]/40 bg-[radial-gradient(ellipse_at_top_left,rgba(164, 73, 46,0.15)_0%,transparent_70%)] p-8 backdrop-blur-xl transition-all duration-300 hover:border-[#a4492e] hover:-translate-y-1 flex flex-col justify-between shadow-xl">
              <div>
                ...
                <div className="text-[10px] font-extrabold uppercase tracking-widest text-[#d9a08a] mb-1">AUTOMATED SAVINGS</div>
      ...
      <section id="ch7" className="relative w-full border-t border-white/10 bg-[#080503] py-24 px-6 lg:px-16 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <h2 className="font-serif text-3xl sm:text-5xl md:text-6xl font-bold text-white mb-8 leading-tight">
            "Luxury should not be reserved for rare moments; it should be your <span className="italic text-[#d9a08a]">everyday signature</span>."
          </h2>
          ...
          <div className="rounded-3xl border border-[#a4492e]/40 bg-black/80 p-8 sm:p-12 backdrop-blur-2xl shadow-2xl mb-12 text-left relative overflow-hidden">
            ...
            <div className="flex items-center justify-between border-t border-white/10 pt-6">
              <div>
                ...
                <div className="text-[10px] font-bold uppercase tracking-widest text-[#a4492e]">Founder &amp; Visionary, SENTIRE By PC</div>
              </div>
              <div className="text-right">
                <div className="text-xs font-mono text-white/50">Jaipur, Rajasthan</div>
                <div className="text-[10px] text-[#d9a08a] uppercase tracking-widest font-bold">EST. DEC 2022</div>
              </div>
            </div>
          </div>
