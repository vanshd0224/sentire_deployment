...
export default function DiscoverySetPage({
  ...
  return (
    <div className="min-h-screen bg-[#f4f2ee] text-[#1c1b18] selection:bg-[#a4492e] selection:text-white font-sans antialiased">
      {/* ── Breadcrumb Navigation ── */}
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-2">
        <div className="flex items-center gap-2 text-[11px] uppercase tracking-[0.2em] text-[#1c1b18]/60 font-medium">
          <button
          ...
          <span>/</span>
          <span className="text-[#a4492e] font-semibold">
            Discovery Set (6 × 6ML)
          </span>
        </div>
      </nav>
      ...
      <section ref={heroRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-7 space-y-5">
            {/* Main Stage Display */}
            <div className="relative aspect-[4/5] sm:aspect-square lg:aspect-[4/5] w-full bg-[#151412] rounded-2xl overflow-hidden border border-[#a4492e]/30 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.5)] group">
              <div className="absolute top-4 left-4 z-10 flex flex-wrap gap-2">
                <span className="px-3 py-1 rounded-full text-[9px] uppercase tracking-[0.2em] font-extrabold bg-[#151412] text-[#a4492e] border border-[#a4492e]/40 shadow-sm">
                  ★ Hero Flagship
                </span>
                <span className="px-3 py-1 rounded-full text-[9px] uppercase tracking-[0.2em] font-bold bg-[#f4f2ee]/90 text-[#4a121a] border border-[#4a121a]/20 backdrop-blur-sm">
                  Oxblood Velvet Case
                </span>
              </div>

              <div className="absolute top-4 right-4 z-10">
                <span className="px-3 py-1 rounded-full text-[10px] font-mono uppercase tracking-[0.16em] font-bold bg-[#a4492e]/20 text-[#7a591e] border border-[#a4492e]/40 backdrop-blur-sm">
                  36ML · 6 SPRAYS
                </span>
              </div>
              ...
              <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-[#151412]/90 via-[#151412]/50 to-transparent p-5 text-white flex flex-col justify-end">
                <p className="text-[10px] font-mono uppercase tracking-[0.25em] text-[#a4492e]">
                ...
                return (
                  <button
                    ...
                    className={`relative aspect-square rounded-xl overflow-hidden border-2 transition-all p-1.5 flex flex-col items-center justify-center cursor-pointer ${
                      isActive
                        ? "border-[#a4492e] bg-white shadow-md ring-2 ring-[#a4492e]/30 scale-[1.02]"
                        : "border-[#e0d6c8] bg-[#f5ede2]/60 hover:border-[#a4492e]/50 opacity-80 hover:opacity-100"
                    }`}
                  >
                    <img
                      src={angle.img}
                    ...
                    <span
                      className={`absolute bottom-1 inset-x-1 text-[8px] sm:text-[9px] font-semibold text-center truncate px-1 rounded ${
                        isActive
                          ? "bg-[#151412] text-[#a4492e]"
                          : "bg-white/85 text-[#1c1b18]/80"
                      }`}
                    >
                      {angle.label}
                    </span>
            ...
            {/* Quick trust strip */}
            <div className="grid grid-cols-3 gap-3 pt-3 border-t border-[#a4492e]/20 text-center">
              <div className="p-2.5 rounded-lg bg-white/70 border border-[#a4492e]/15 shadow-xs">
                <p className="text-[10px] uppercase tracking-[0.16em] text-[#a4492e] font-bold">Volume</p>
                <p className="text-xs font-semibold text-[#1c1b18] mt-0.5">6 × 6ML (36ML)</p>
              </div>
              <div className="p-2.5 rounded-lg bg-white/70 border border-[#a4492e]/15 shadow-xs">
                <p className="text-[10px] uppercase tracking-[0.16em] text-[#a4492e] font-bold">Spray Count</p>
                <p className="text-xs font-semibold text-[#1c1b18] mt-0.5">~360 Fine Mists</p>
              </div>
              <div className="p-2.5 rounded-lg bg-white/70 border border-[#a4492e]/15 shadow-xs">
                <p className="text-[10px] uppercase tracking-[0.16em] text-[#a4492e] font-bold">Portability</p>
                <p className="text-xs font-semibold text-[#1c1b18] mt-0.5">TSA & Clutch Safe</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col space-y-6">
            <div>
              ...
              <div className="flex items-center gap-2 mb-2">
                <span className="h-px w-6 bg-[#a4492e]" />
                <span className="text-[10.5px] uppercase tracking-[0.28em] text-[#a4492e] font-extrabold">
                  SENTIRE HAUTE PARFUMERIE
                </span>
              </div>

              {/* Title & Headline */}
              <h1 className="text-3xl sm:text-4xl lg:text-[42px] leading-[1.1] font-serif font-normal text-[#151412] tracking-tight">
                SENTIRE Discovery Set
              </h1>
              <p className="mt-2 text-lg sm:text-xl font-serif italic text-[#a4492e] font-medium">
            ...
            <div className="flex items-center gap-3 pb-3 border-b border-[#e5dcce]">
              <div className="flex items-center text-[#a4492e] text-sm">
                {"★★★★★".split("").map((star, i) => (
                  <span key={i} className="text-[#a4492e]">
                    ★
                  </span>
                ))}
              </div>
              <span className="text-xs font-bold text-[#1c1b18]">4.9</span>
              <span className="text-xs text-[#1c1b18]/60 underline">
            ...
            {/* Price block */}
            <div className="p-4 rounded-xl bg-gradient-to-br from-[#f6f1ea] to-[#efe7db] border border-[#a4492e]/30 shadow-xs">
              <div className="flex items-baseline gap-3">
                <span className="text-3xl sm:text-4xl font-serif font-bold text-[#1c1b18] tabular-nums">
                  ₹549
                </span>
                <span className="text-base text-[#1c1b18]/45 line-through tabular-nums">
                  ₹999
                </span>
              ...
              <div className="mt-2 flex items-center justify-between text-xs text-[#1c1b18]/80">
            ...
            <blockquote className="border-l-2 border-[#a4492e] pl-4 py-1 text-sm sm:text-base font-serif italic text-[#1c1b18]/85 leading-relaxed bg-[#f9f5ef]/70 rounded-r-lg">
            ...
            <div>
              <p className="text-[11px] uppercase tracking-[0.18em] font-bold text-[#1c1b18]/75 mb-2.5 flex items-center justify-between">
                <span>The Six Fragrances Included:</span>
                <span className="text-[#a4492e] text-[10px] lowercase italic font-serif">
                  ...
                  return (
                    <button
                      ...
                      className={`group relative p-1.5 rounded-xl border flex flex-col items-center justify-center transition-all cursor-pointer ${
                        isSelected
                          ? "border-[#a4492e] bg-white shadow-md ring-2 ring-[#a4492e]/30"
                          : "border-[#e6ded1] bg-[#f8f3eb] hover:border-[#a4492e]/40"
                      }`}
                      title={frag.name}
                    >
                      ...
                      <span className="text-[9px] font-bold text-center truncate w-full mt-1 text-[#1c1b18]">
                        {frag.name.split(" ")[0]}
                      </span>
                    </button>
                  );
              ...
              <p className="text-xs text-[#1c1b18]/70 mt-2 font-medium">
                Active preview: <strong className="text-[#a4492e]">{currentFragrance.name}</strong> — {currentFragrance.tagline}
              </p>
            </div>
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3">
                {/* Qty Pill */}
                <div className="flex items-center border border-[#a4492e]/40 rounded-xl bg-white px-2 py-1 shadow-xs">
                  <button
                    onClick={() => setQuantity((q) => Math.max(1, q - 1))}
                    disabled={quantity <= 1}
                    className="w-8 h-9 flex items-center justify-center text-lg font-bold text-[#1c1b18] hover:text-[#a4492e] disabled:opacity-30 cursor-pointer"
                  >
                    −
                  </button>
                  ...
                  <button
                    ...
                    className="w-8 h-9 flex items-center justify-center text-lg font-bold text-[#1c1b18] hover:text-[#a4492e] cursor-pointer"
                  >
                    +
                  </button>
                </div>
                ...
                <button
                  ...
                  className={`flex-1 py-3.5 px-6 rounded-xl font-bold text-xs sm:text-sm uppercase tracking-[0.2em] transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer shadow-lg ${
                    addedAnimation
                      ...
                      : "bg-[#151412] hover:bg-[#201914] text-[#a4492e] hover:shadow-[0_10px_25px_rgba(164, 73, 46,0.35)] active:scale-[0.98]"
                  }`}
                >
                  {addedAnimation ? (
                    <>
              ...
              <button
                ...
                className="w-full py-3 px-6 rounded-xl font-bold text-xs uppercase tracking-[0.2em] bg-gradient-to-r from-[#a4492e] via-[#a4492e] to-[#a37c3f] text-[#151412] hover:brightness-105 shadow-md active:scale-[0.98] transition-all cursor-pointer text-center"
              >
            ...
            <div className="pt-2 border-t border-[#e2d8c9] space-y-2 text-xs text-[#1c1b18]/75">
              <div className="flex items-center gap-2.5">
                <span className="text-[#a4492e] text-base">✈</span>
      ...
      ───────────────────────────────────────────────────────────── */}
      <section className="py-16 sm:py-24 bg-[#0d0a08] text-[#f4f2ee] relative overflow-hidden">
        {/* Background glow effects */}
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-[#a4492e]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <span className="px-3 py-1 rounded-full text-[10px] uppercase tracking-[0.25em] font-extrabold bg-[#a4492e]/15 text-[#a4492e] border border-[#a4492e]/30">
              The 6ML Curation
            </span>
              ...
              return (
                <button
                  ...
                  className={`px-4 sm:px-5 py-2.5 rounded-full text-xs font-semibold tracking-wider transition-all cursor-pointer flex items-center gap-2 ${
                    isActive
                      ? "bg-[#a4492e] text-[#151412] shadow-[0_0_20px_rgba(164, 73, 46,0.4)] font-bold scale-105"
          ...
          <div className="mt-10 bg-gradient-to-b from-[#1c1b18] to-[#151412] border border-[#a4492e]/35 rounded-3xl p-6 sm:p-10 shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-5 flex flex-col items-center justify-center relative">
                ...
                <div className="relative aspect-[3/5] w-64 sm:w-72 bg-gradient-to-b from-white/10 to-white/5 rounded-2xl border border-white/10 p-4 flex flex-col items-center justify-between shadow-2xl backdrop-blur-md group">
                  <div className="w-full flex items-center justify-between text-[10px] font-mono tracking-widest text-white/50 uppercase">
                    ...
                    <span className="text-[#a4492e]">6ML EXTRAIT</span>
                  </div>
                  ...
                  <div className="w-full text-center">
                    <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#a4492e]">
              ...
              <div className="lg:col-span-7 space-y-6">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2.5 py-0.5 rounded-full text-[9px] uppercase tracking-[0.2em] font-extrabold bg-[#a4492e]/20 text-[#a4492e] border border-[#a4492e]/40">
                  ...
                  <p className="text-base sm:text-lg font-serif italic text-[#a4492e] mt-1">
                ...
                <div className="space-y-3 bg-black/40 rounded-2xl p-5 border border-white/5">
                  <div className="flex items-start gap-3">
                    <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#a4492e] w-14 shrink-0 pt-0.5">
                      Top
                    </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="p-3 rounded-xl bg-white/5 border border-white/5">
                    <p className="text-[10px] uppercase tracking-wider text-[#a4492e] font-bold">Projection / Sillage</p>
                    <p className="text-xs font-semibold text-white mt-1">{currentFragrance.sillage}</p>
                  </div>
                  <div className="p-3 rounded-xl bg-white/5 border border-white/5">
                    <p className="text-[10px] uppercase tracking-wider text-[#a4492e] font-bold">Skin Longevity</p>
                    <p className="text-xs font-semibold text-white mt-1">{currentFragrance.longevity}</p>
                  </div>
                  <div className="p-3 rounded-xl bg-white/5 border border-white/5">
                    <p className="text-[10px] uppercase tracking-wider text-[#a4492e] font-bold">Best Setting</p>
                ...
                <div className="p-3.5 rounded-xl bg-[#4a121a]/20 border border-[#4a121a]/40 flex items-center gap-3">
                  <span className="text-base text-[#a4492e]">✨</span>
                  <div className="text-xs">
                    <strong className="text-[#a4492e] uppercase tracking-wider">Layering Role ({currentFragrance.layeringRole}):</strong>{" "}
            ...
            {DISCOVERY_FRAGRANCES.map((frag, idx) => (
              <div
                ...
                className={`p-5 rounded-2xl border transition-all cursor-pointer flex flex-col justify-between ${
                  idx === selectedFragranceIndex
                    ? "bg-[#1f1914] border-[#a4492e] shadow-[0_10px_30px_rgba(164, 73, 46,0.15)]"
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="text-[9px] font-mono uppercase tracking-[0.2em] text-[#a4492e]">
                ...
                <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between text-[11px] text-white/50">
                  ...
                  <span className="text-[#a4492e] font-medium group-hover:underline">
                    View Notes →
                  </span>
                </div>
              </div>
      ...
      ───────────────────────────────────────────────────────────── */}
      <section className="py-16 sm:py-24 bg-[#faf5ee] border-y border-[#a4492e]/25">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="max-w-3xl mx-auto text-center space-y-3">
            <span className="px-3 py-1 rounded-full text-[10px] uppercase tracking-[0.25em] font-extrabold bg-[#151412] text-[#a4492e]">
              The Scent Science
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif text-[#1c1b18]">
              Why 6ML Matters
            </h2>
            <p className="text-base sm:text-lg font-serif italic text-[#1c1b18]/80 leading-relaxed">
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-8 rounded-3xl bg-white border border-red-200/60 shadow-sm relative overflow-hidden">
              ...
              <h3 className="text-xl font-serif font-bold text-[#1c1b18]">
              ...
              <ul className="mt-6 space-y-4 text-xs sm:text-sm text-[#1c1b18]/75">
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-br from-[#1b1511] to-[#151412] text-white border-2 border-[#a4492e] shadow-xl relative overflow-hidden">
              <div className="absolute top-4 right-4">
                <span className="px-2.5 py-1 rounded-full text-[9px] uppercase tracking-widest font-extrabold bg-[#a4492e] text-[#151412]">
                  The SENTIRE Way
                </span>
              </div>
              <h3 className="text-xl font-serif font-bold text-[#a4492e]">
              ...
              <ul className="mt-6 space-y-4 text-xs sm:text-sm text-white/85">
                <li className="flex items-start gap-3">
                  <span className="text-[#a4492e] font-bold">✓</span>
          ...
          <div className="mt-14 max-w-4xl mx-auto p-6 sm:p-8 rounded-3xl bg-white border border-[#a4492e]/30 shadow-md">
            <div className="text-center max-w-xl mx-auto">
              <h4 className="text-lg sm:text-xl font-serif font-bold text-[#1c1b18]">
                Calculate Your Wear Time Across 36ML
              </h4>
              <p className="text-xs text-[#1c1b18]/70 mt-1">
              ...
              {[1, 2, 3, 4].map((sprays) => (
                <button
                  ...
                  className={`px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
                    spraysPerDay === sprays
                      ? "bg-[#151412] text-[#a4492e] shadow-md scale-105"
                      : "bg-[#f5ede2] text-[#1c1b18]/70 hover:bg-[#a4492e]/20"
                  }`}
                >
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
              <div className="p-4 rounded-2xl bg-[#f4f2ee] border border-[#e6dcce]">
                <p className="text-[10px] uppercase tracking-widest text-[#a4492e] font-extrabold">Total Sprays</p>
                <p className="text-2xl sm:text-3xl font-serif font-bold text-[#1c1b18] mt-1">360</p>
                <p className="text-[11px] text-[#1c1b18]/60 mt-0.5">60 sprays × 6 vials</p>
              </div>
              <div className="p-4 rounded-2xl bg-[#f4f2ee] border border-[#e6dcce]">
                <p className="text-[10px] uppercase tracking-widest text-[#a4492e] font-extrabold">Days of Continuous Wear</p>
              ...
              <div className="p-4 rounded-2xl bg-[#f4f2ee] border border-[#e6dcce]">
                <p className="text-[10px] uppercase tracking-widest text-[#a4492e] font-extrabold">Cost Per Day</p>
                <p className="text-2xl sm:text-3xl font-serif font-bold text-[#1c1b18] mt-1">
                  ₹{(549 / (360 / spraysPerDay)).toFixed(2)}
                </p>
                <p className="text-[11px] text-[#1c1b18]/60 mt-0.5">Haute perfumery value</p>
              </div>
            </div>
          </div>
        </div>
      ...
      ───────────────────────────────────────────────────────────── */}
      <section className="py-16 sm:py-24 bg-[#f4f2ee]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="max-w-3xl mx-auto text-center space-y-3">
            <span className="px-3 py-1 rounded-full text-[10px] uppercase tracking-[0.25em] font-extrabold bg-[#a4492e]/20 text-[#846124] border border-[#a4492e]/30">
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Step 1 */}
            <div className="p-8 rounded-3xl bg-white border border-[#e8dfd2] shadow-sm relative group hover:border-[#a4492e] transition-all">
              <div className="w-12 h-12 rounded-2xl bg-[#151412] text-[#a4492e] font-serif font-bold text-xl flex items-center justify-center mb-6">
                01
              </div>
              <h3 className="text-xl font-serif font-bold text-[#1c1b18]">
                Give Each Its Own Day
              </h3>
              <p className="text-xs sm:text-sm text-[#1c1b18]/75 mt-3 leading-relaxed">
          ...
          <div className="mt-16 bg-gradient-to-br from-[#151412] via-[#1a1410] to-[#0c0907] rounded-3xl p-6 sm:p-12 text-white border border-[#a4492e]/40 shadow-2xl">
            <div className="max-w-2xl mx-auto text-center space-y-2">
              <span className="px-3 py-1 rounded-full text-[9px] uppercase tracking-[0.25em] font-extrabold bg-[#a4492e]/20 text-[#a4492e] border border-[#a4492e]/30">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="p-5 rounded-2xl bg-white/5 border border-white/10 space-y-3">
                <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#a4492e] flex items-center justify-between">
                  ...
                  {DISCOVERY_FRAGRANCES.slice(0, 3).map((f) => (
                    <button
                      ...
                      className={`p-2.5 rounded-xl border text-center transition-all cursor-pointer ${
                        selectedBaseId === f.id
                          ? "border-[#a4492e] bg-[#a4492e]/20 text-white font-bold"
            ...
            <div className="mt-8 p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-[#1e1712] via-[#241a15] to-[#1e1712] border border-[#a4492e]/50 text-center space-y-3">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#151412] border border-[#a4492e]/40 text-[#a4492e] text-[10px] font-mono tracking-widest uppercase">
                <span>✦ Custom Blend Formula</span>
              </div>
              <h4 className="text-2xl sm:text-3xl font-serif text-white">
                {activeRecipe.name}
              </h4>
              <p className="text-xs sm:text-sm font-mono text-[#a4492e] uppercase tracking-wider">
      ...
      ───────────────────────────────────────────────────────────── */}
      <section className="py-16 sm:py-24 bg-[#121110] text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6">
              <div className="relative aspect-square max-w-md mx-auto rounded-3xl overflow-hidden border border-[#a4492e]/30 shadow-[0_20px_50px_rgba(0,0,0,0.6)] group">
                <img
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <span className="text-[10px] font-mono uppercase tracking-[0.25em] text-[#a4492e]">
            ...
            <div className="lg:col-span-6 space-y-6">
              <span className="px-3 py-1 rounded-full text-[10px] uppercase tracking-[0.25em] font-extrabold bg-[#4a121a] text-[#f7e7ce] border border-[#a4492e]/40">
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-[#a4492e]/20 text-[#a4492e] flex items-center justify-center font-bold text-xs shrink-0">
                    1
                  </div>
                  <div>
              ...
              <div className="pt-4">
                <button
                  onClick={handleAddToCart}
                  className="py-3.5 px-8 rounded-xl bg-[#a4492e] text-[#151412] font-bold text-xs uppercase tracking-[0.2em] hover:bg-[#a4492e] transition-all cursor-pointer shadow-lg active:scale-95"
                >
                  Acquire the Set — ₹549
                </button>
              </div>
      ...
      <section className="py-16 sm:py-24 bg-[#f4f2ee]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <span className="text-[10px] uppercase tracking-[0.25em] text-[#a4492e] font-extrabold">
              Real Impressions
            </span>
            <h2 className="text-3xl sm:text-4xl font-serif text-[#1c1b18]">
              Loved by Scent Connoisseurs
            </h2>
            <p className="text-xs sm:text-sm text-[#1c1b18]/70">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-white border border-[#e5dccd] shadow-xs flex flex-col justify-between">
              <div>
                <div className="flex items-center text-[#a4492e] text-xs">
                  ★★★★★
                </div>
                <p className="text-sm font-serif italic text-[#1c1b18]/90 mt-3 leading-relaxed">
              ...
              <div className="mt-4 pt-3 border-t border-[#f0e8dc] flex items-center justify-between text-xs">
                <span className="font-bold text-[#1c1b18]">Aarav M.</span>
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#e5dccd] shadow-xs flex flex-col justify-between">
              ...
              <div className="mt-4 pt-3 border-t border-[#f0e8dc] flex items-center justify-between text-xs">
                <span className="font-bold text-[#1c1b18]">Rhea K.</span>
                <span className="text-emerald-700 font-medium">✓ Verified Buyer</span>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#e5dccd] shadow-xs flex flex-col justify-between">
              ...
              <div className="mt-4 pt-3 border-t border-[#f0e8dc] flex items-center justify-between text-xs">
                <span className="font-bold text-[#1c1b18]">Kabir S.</span>
                <span className="text-emerald-700 font-medium">✓ Verified Buyer</span>
              </div>
            </div>
          </div>
      ...
      ───────────────────────────────────────────────────────────── */}
      <section className="py-16 sm:py-24 bg-[#f4ece1] border-t border-[#a4492e]/20">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full px-6 py-4 text-left flex items-center justify-between text-sm sm:text-base font-serif font-bold text-[#1c1b18] hover:text-[#a4492e] transition-colors cursor-pointer"
                  >
                    <span>{faq.q}</span>
                    <span className="text-lg font-mono text-[#a4492e] ml-4">
                      {isOpen ? "−" : "+"}
                    </span>
                  </button>
                  {isOpen && (
                    <div className="px-6 pb-5 text-xs sm:text-sm text-[#1c1b18]/80 leading-relaxed border-t border-[#f5ede2] pt-3 font-sans">
                      {faq.a}
                    </div>
                  )}
                </div>
      ...
      ───────────────────────────────────────────────────────────── */}
      <section className="py-16 bg-[#151412] text-white text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 space-y-6 relative z-10">
          <span className="px-3 py-1 rounded-full text-[10px] uppercase tracking-[0.28em] font-extrabold bg-[#a4492e]/20 text-[#a4492e] border border-[#a4492e]/40">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            <button
              onClick={handleAddToCart}
              className="py-4 px-8 rounded-xl bg-[#a4492e] hover:bg-[#a4492e] text-[#151412] font-bold text-xs uppercase tracking-[0.2em] transition-all shadow-xl active:scale-95 cursor-pointer"
            >
              Add To Cart — ₹549
            </button>
            <button
              onClick={() => onNavigate?.("perfumes")}
              className="py-4 px-8 rounded-xl bg-transparent border border-white/30 hover:border-[#a4492e] text-white font-bold text-xs uppercase tracking-[0.2em] transition-all cursor-pointer"
            >
      ...
      {showStickyBar && (
        <div
          className="fixed left-0 right-0 z-40 bg-[#151412]/95 backdrop-blur-xl border-t border-[#a4492e]/40 p-3 sm:p-4 text-white shadow-2xl transition-all animate-fadeIn"
          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 min-w-0">
              <img
                ...
                alt="Discovery Set"
                className="w-10 h-10 object-contain rounded-lg bg-[#1a1410] border border-[#a4492e]/30 shrink-0"
              />
              <div className="min-w-0">
                <p className="text-xs sm:text-sm font-serif font-bold text-white truncate">
                  SENTIRE Discovery Set
                </p>
                <p className="text-[10px] text-[#a4492e] font-mono truncate">
                  6 × 6ML · ₹549 (Save 45%)
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                onClick={handleAddToCart}
                className="py-2.5 px-5 rounded-xl bg-[#a4492e] hover:bg-[#a4492e] text-[#151412] font-bold text-xs uppercase tracking-[0.16em] transition-all shadow-md active:scale-95 cursor-pointer flex items-center gap-1.5"
              >
                <span>Add to Cart</span>
