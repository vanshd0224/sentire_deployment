...
const qualityBadges: QualityBadge[] = [
  {
    ...
    sub: "U.S. VERIFIED",
    cardStyle:
      "bg-sky-50/90 border-sky-200/90 hover:border-sky-400 hover:shadow-sky-100/50",
    ...
    icon: (
      <div className="relative flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-sky-500 to-blue-700 text-white shadow-md shadow-sky-500/25 shrink-0">
        ...
        <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
          {" "}
          <path
            d="M12 2L4 5v6c0 5.25 3.5 10.15 8 11.35 4.5-1.2 8-6.1 8-11.35V5l-8-3z"
            fill="currentColor"
            fillOpacity="0.25"
            stroke="currentColor"
            strokeWidth={1.8}
  ...
  },
  {
    ...
    sub: "DERM TESTED",
    cardStyle:
      "bg-rose-50/90 border-rose-200/90 hover:border-rose-400 hover:shadow-rose-100/50",
    ...
    icon: (
      <div className="relative flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-green-700 text-white shadow-md shadow-emerald-500/25 shrink-0">
        ...
        <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
          ...
          />{" "}
          <path
            d="M9 14.5c2-2.5 5.5-2.5 6 0M12 7.5v4"
            stroke="#ffffff"
            strokeWidth={2}
            strokeLinecap="round"
          />{" "}
  ...
  },
  {
    ...
    sub: "PURE SAFE",
    cardStyle:
      "bg-cyan-50/90 border-cyan-200/90 hover:border-cyan-400 hover:shadow-cyan-100/50",
  ...
  },
  {
    ...
    sub: "CERTIFIED 100%",
    cardStyle:
      "bg-amber-50/90 border-amber-200/90 hover:border-amber-400 hover:shadow-amber-100/50",
    ...
    icon: (
      <div className="relative flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 via-amber-500 to-yellow-600 text-white shadow-md shadow-amber-500/25 shrink-0">
        ...
        <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
          ...
          />{" "}
          <path
            d="M9 17.5l-1.5 4.5 4.5-2.5 4.5 2.5-1.5-4.5"
            stroke="#ffffff"
            strokeWidth={1.8}
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  },
  {
    ...
    cardStyle:
      "bg-purple-50/90 border-purple-200/90 hover:border-purple-400 hover:shadow-purple-100/50",
    ...
    icon: (
      <div className="relative flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-violet-700 text-white shadow-md shadow-purple-500/25 shrink-0">
        ...
        <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
          {" "}
          <path
            d="M12 20.5c-4.5 0-7.5-3-7.5-6.5C4.5 11.5 6 9 9 7.5c0-3.5 1.5-6 3-6s3 2.5 3 6c3 1.5 4.5 4 4.5 6.5 0 3.5-3 6.5-7.5 6.5z"
            fill="#ffffff"
            fillOpacity="0.3"
            stroke="#ffffff"
            strokeWidth={1.8}
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-1.5">
                  {" "}
                  <span
                    className={`text-[11.5px] font-black tracking-[0.06em] uppercase whitespace-nowrap ${badge.textStyle}`}
                  >
                    {" "}
                    {badge.name}
                  </span>{" "}
                ...
                <span
                  className={`text-[8.5px] font-bold tracking-wider uppercase px-1.5 py-0.2 rounded border w-max mt-0.5 ${badge.subStyle}`}
                >
                  {" "}
                  {badge.sub}
                </span>{" "}
