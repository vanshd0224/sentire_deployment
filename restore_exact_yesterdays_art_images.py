...
# 1. Update BestSellers.tsx with exact yesterday's luxury art images (Screenshot 102)
...
const products: ProductItem[] = [
  {
    ...
    image: "/assets/images/purple-oud-bestseller.png?v=5",
    badge: "Best Seller",
    rating: 4.91,
    reviewsCount: 165,
    prices: {
  ...
  },
  {
    ...
    image: "/assets/images/purple-oud-arrival.png?v=5",
    badge: "Exclusive",
    rating: 4.95,
    reviewsCount: 98,
    prices: {
  ...
  },
  {
    ...
    image: "/assets/images/calantha.png?v=5",
    badge: "Best Seller",
    rating: 4.85,
    reviewsCount: 116,
    prices: {
  ...
  },
  {
    ...
    image: "/assets/images/mirai.png?v=5",
    badge: "Best Seller",
    rating: 4.87,
    reviewsCount: 132,
    prices: {
  ...
  },
  {
    ...
    image: "/assets/images/deep-crush.png?v=5",
    badge: "Best Seller",
    rating: 4.9,
    reviewsCount: 142,
    prices: {
...
# 2. Update NewArrivals.tsx with exact yesterday's luxury art images (RICH, PURPLE OUD, CALANTHA, HERRLICH)
...
const products: ProductItem[] = [
  {
    ...
    image: "/assets/images/rich.png?v=5",
    badge: "New Launch",
    rating: 4.93,
    reviewsCount: 54,
    prices: {
  ...
  },
  {
    ...
    image: "/assets/images/herrlich.png?v=5",
    badge: "New Launch",
    rating: 4.92,
    reviewsCount: 48,
    prices: {
...
# 3. Update PerfumesPage.tsx to use /assets/images/purple-oud-arrival.png?v=5 for Purple Oud banner
perfumes_page_path = os.path.join(src_dir, "components", "PerfumesPage.tsx")
with open(perfumes_page_path, "r", encoding="utf-8") as f:
    p_code = f.read()

p_code = p_code.replace('/assets/purple-oud-banner.png?v=4', '/assets/images/purple-oud-arrival.png?v=5')
p_code = p_code.replace('/assets/purple-oud-banner.png', '/assets/images/purple-oud-arrival.png?v=5')

with open(perfumes_page_path, "w", encoding="utf-8") as f:
    f.write(p_code)

print("SUCCESS: Restored exact yesterday art images for Purple Oud banner, Best Sellers, and New Arrivals!")
