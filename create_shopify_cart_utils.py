...
utils_dir = r"C:\Users\asus\.gemini\antigravity\scratch\sentire_deployment\frontend\src\utils"
os.makedirs(utils_dir, exist_ok=True)

utils_path = os.path.join(utils_dir, "shopifyCart.ts")

code = """// Official Shopify Storefront API Cart Manager
...
print("SUCCESS: Created frontend/src/utils/shopifyCart.ts with syncAddToCartToShopifyStorefront function!")
