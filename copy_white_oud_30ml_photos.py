...
# Copy the top 3 most recent uploaded files as white-oud-30ml-1, 2, 3
...
dests = [
    r"C:\Users\asus\.gemini\antigravity\scratch\sentire_deployment\frontend\public\assets\perfumes\white-oud\30ml",
...
for d in dests:
    ...
    shutil.copy(img1, os.path.join(d, "white-oud-30ml-1.png"))
    shutil.copy(img2, os.path.join(d, "white-oud-30ml-2.png"))
    shutil.copy(img3, os.path.join(d, "white-oud-30ml-3.png"))

print("SUCCESS: Copied White Oud 30 ML images into all asset directory variants!")
