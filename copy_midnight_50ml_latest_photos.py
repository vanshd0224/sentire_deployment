...
img1 = os.path.join(artifacts_dir, "media_1786955709002.png") # bottle on starry background with full moon
img2 = os.path.join(artifacts_dir, "media_1786955709061.jpg") # black box with gold cubes
img3 = os.path.join(artifacts_dir, "media_1786955709159.png") # box in hand at bar scene
