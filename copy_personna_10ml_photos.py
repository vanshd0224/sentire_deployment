...
dests = [
    r"C:\Users\asus\.gemini\antigravity\scratch\sentire_deployment\frontend\public\assets\perfumes\personna\10ml",
...
for d in dests:
    ...
    shutil.copy(img1, os.path.join(d, "personna-10ml-1.png"))
    shutil.copy(img2, os.path.join(d, "personna-10ml-2.png"))
    shutil.copy(img3, os.path.join(d, "personna-10ml-3.png"))

print("SUCCESS: Copied Personna 10 ML images into all asset directory variants!")
