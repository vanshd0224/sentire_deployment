...
# 1. Restore BestSellers.tsx with exact original layout & images, updating ONLY prices
...
with open(bs_path, "w", encoding="utf-8") as f:
    f.write(bs_code)
print("RESTORED: BestSellers.tsx with original names, images, and Excel prices!")

# 2. Restore NewArrivals.tsx with exact original layout & images, updating ONLY prices
...
const products: ProductItem[] = [
  ...
  },
  {
    id: "midnight",
    name: "MIDNIGHT",
    notes: "Blackcurrant • Tuberose • Vanilla Musk",
    image: "/assets/midnight.png?v=3",
    badge: "Limited Edition",
    rating: 4.89,
    reviewsCount: 62,
    prices: {
      10: { price: 549, originalPrice: 649 },
      30: { price: 1399, originalPrice: 2129 },
  ...
  },
  {
    ...
    image: "/assets/0809.png?v=3",
    badge: "Exclusive",
    rating: 4.94,
    reviewsCount: 53,
    prices: {
      10: { price: 699, originalPrice: 779 },
      30: { price: 1994, originalPrice: 2759 },
      50: { price: 2889, originalPrice: 4069 },
    },
  },
];
...
with open(na_path, "w", encoding="utf-8") as f:
    f.write(na_code)
print("RESTORED: NewArrivals.tsx with original names, images, and Excel prices!")
