...
# Update perfumes.ts for 0809 size 30
...
pattern = r'id:\s*["\']0809["\'][\s\S]*?30:\s*\[[^\]]*\]'
replacement = lambda m: re.sub(r'30:\s*\[[^\]]*\]', new_0809_30ml, m.group(0))
...
print("SUCCESS: Updated 0809 sizeImages for 30ml in perfumes.ts!")
