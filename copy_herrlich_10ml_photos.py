...
for d in dests:
    ...
    shutil.copy(img1, os.path.join(d, "herrlich-10ml-1.png"))
    shutil.copy(img2, os.path.join(d, "herrlich-10ml-2.png"))
    shutil.copy(img3, os.path.join(d, "herrlich-10ml-3.png"))

print("SUCCESS: Copied Herrlich 10 ML images into all asset directory variants!")
