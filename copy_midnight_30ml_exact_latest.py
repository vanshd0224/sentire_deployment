...
print("=== CHECKING LATEST USER UPLOADED FILES FOR MIDNIGHT 30ML ===")
...
img1 = os.path.join(artifacts_dir, files_sorted[2]) # Image 1: bottle on box with moon background
img2 = os.path.join(artifacts_dir, files_sorted[1]) # Image 2: bottle in crescent moon with full moon background
img3 = os.path.join(artifacts_dir, files_sorted[0]) # Image 3: black box on gold & teal display
...
print("SUCCESS: Updated Midnight 30 ML with the exact 3 studio photos!")
