...
dests = [
    r"C:\Users\asus\.gemini\antigravity\scratch\sentire_deployment\frontend\public\assets\perfumes\seductive\50ml",
...
for d in dests:
    ...
    shutil.copy(img1, os.path.join(d, "seductive-50ml-1.png"))
    shutil.copy(img2, os.path.join(d, "seductive-50ml-2.png"))
    shutil.copy(img3, os.path.join(d, "seductive-50ml-3.png"))

print("SUCCESS: Copied Seductive 50 ML images into all asset directory variants!")
