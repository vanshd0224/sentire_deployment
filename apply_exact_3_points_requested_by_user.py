...
# 1. Copy exact purple-oud-arrival.png from images to assets/purple-oud-banner.png for Point 1
purple_arrival_src = os.path.join(images_dir, "purple-oud-arrival.png")
purple_banner_dest = os.path.join(assets_dir, "purple-oud-banner.png")
if os.path.exists(purple_arrival_src):
    shutil.copyfile(purple_arrival_src, purple_banner_dest)
    print("SUCCESS: Copied purple-oud-arrival.png to assets/purple-oud-banner.png!")

# 2. Update Purple Oud banner in PerfumesPage.tsx to use /assets/purple-oud-banner.png and price 1489 / MRP 1859
perfumes_page_path = os.path.join(src_dir, "components", "PerfumesPage.tsx")
with open(perfumes_page_path, "r", encoding="utf-8") as f:
    p_code = f.read()

# Replace img property of EXCLUSIVE_PURPLE_OUD or Purple Oud hero section
p_code = p_code.replace('EXCLUSIVE_PURPLE_OUD.img', '"/assets/purple-oud-banner.png?v=4"')

with open(perfumes_page_path, "w", encoding="utf-8") as f:
    f.write(p_code)

print("SUCCESS Point 1: Updated Purple Oud banner image & price on PerfumesPage.tsx!")

# 3. Update Point 2: New Arrivals section (RICH, PURPLE OUD, CALANTHA, HERRLICH)
...
print("SUCCESS Point 2: New Arrivals updated to exactly RICH, PURPLE OUD, CALANTHA, HERRLICH!")

# 4. Update Point 3: Best Sellers section (SEDUCTIVE, PURPLE OUD, CALANTHA, MIRAI, DEEP CRUSH)
...
print("SUCCESS Point 3: Best Sellers updated to exactly SEDUCTIVE, PURPLE OUD, CALANTHA, MIRAI, DEEP CRUSH!")
